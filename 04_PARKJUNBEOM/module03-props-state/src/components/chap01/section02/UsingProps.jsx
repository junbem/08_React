...
*/
// 구조분해를 사용하지 않고 props객체를 직접 사용하는 겨우
...
function GreetingDestructuring({ name, day = "쉬는 날" }) {
  return (
    <div>
      <p>안녕하세요, {name}님</p>
      <p>오늘은 {day}입니다.</p>
...
export default function UsingProps() {
  return (
    <div>
      <Greeting name="홍길동" day="금요일"></Greeting>
      <GreetingDestructuring name="유관순" day="금요일"></GreetingDestructuring>
      <GreetingDestructuring name="강감찬"></GreetingDestructuring>
    </div>
  );
}
